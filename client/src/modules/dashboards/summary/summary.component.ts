...
export class SummaryComponent implements OnInit {
   ...
   */
  constructor(private _fuseSidebarService: FuseSidebarService, private _summaryService: SummaryService) {
   ...
   */
  ngOnInit(): void {
    this.projects = this._summaryService.projects;
    this.selectedProject = this.projects[0];
    this.widgets = this._summaryService.widgets;
